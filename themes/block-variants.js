...
const BlockVariants = {
    ...
    // Данные проектов
    allProjects: [
        { img: 'projects/gemini-voice-writer/preview/preview-optimized.png', icon: '🎙️', title: 'Gemini Voice Writer', desc: 'Desktop-приложение для голосового ввода с AI-транскрипцией', tags: ['Python', 'PyQt6', 'Gemini'], link: 'projects/gemini-voice-writer/' },
        { img: 'projects/telegram-spammer/preview/preview-optimized.png', icon: '📱', title: 'Telegram Spammer', desc: 'Автоматическая рассылка комментариев с антибан-защитой', tags: ['Python', 'Telethon', 'Web UI'], link: 'projects/telegram-spammer/' },
        { img: 'projects/totoro-bot/preview/preview-optimized.png', icon: '🍃', title: 'TotoroDiet', desc: 'Telegram Mini App — трекер питания с AI-анализом фото', tags: ['Python', 'Gemini', 'Supabase'], link: 'projects/totoro-bot/' },
        { img: 'projects/vapecity-app/preview/preview-optimized.png', icon: '💨', title: 'VapeCity App', desc: 'Telegram Mini App для сети вейп-шопов — каталог, точки продаж, бонусы', tags: ['React', 'TypeScript', 'Express'], link: 'projects/vapecity-app/' }
    ],
